...
<%@page import="com.service.impl.T_goodsServiceImpl"%>
<%@page import="com.service.T_goodsService"%>
<%@page import="com.entity.T_goods"%>
<%@page import="java.util.List"%>

<%@ taglib uri="http://java.sun.com/jstl/core_rt" prefix="c"%>
<%@page import="com.service.impl.T_goodsTypeServiceImpl"%>
<%@page import="com.service.T_goodsTypeService"%>
<%@page import="com.entity.T_goodsType"%>
<%@page import="java.util.List"%>
...
if(sid!=null){
		...
		T_goods goods=ss.getgoodById(id);
...
<div class="container" style="margin-top: 20px;">
    ...
    <form class="form-horizontal" enctype="multipart/form-data"
          action="${pageContext.request.contextPath}/updateOrAddT_goods" method="post"  >
            ...
            <div class="col-sm-10">
                <div class="input-group">
                    <div class="input-group-btn">
                      ...
                      <%   T_goodsTypeService a= new  T_goodsTypeServiceImpl();
                            List<T_goodsType> list=a.getAll();
                    ...
                    <input type="hidden" class="form-control" id="typeId" name="typeId" value="${type.id}">
                    <input type="text" class="form-control" disabled id="typeName" value="${type.typename}"
                           aria-label="...">
                </div><!-- /input-group -->
            </div>
        </div>
