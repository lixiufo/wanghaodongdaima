...
<script type="text/javascript">
    ...
    function addGoodsType() {
        location.href = "${pageContext.request.contextPath}/after/add_goods_type.jsp";
    }
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse"
            ...
            <ul class="nav navbar-nav">
                <li class="active"><a href="<%=path %>/zhumohu" method="post">商品管理 <span class="sr-only">(current)</span></a></li>
            ...
            <tr>
                ...
                <td><a><span class="glyphicon glyphicon-edit"
                             ...
                             onclick="showEdit(${goodsType.id},'${goodsType.typename}')"></span></a></td>
                                ...
                                <td><a href="<%=path%>/delT_goodsType?id=${obj.count}">删除</a></td>     
